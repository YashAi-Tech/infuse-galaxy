...
import { GameObject, ObjectType, LANE_WIDTH, SPAWN_DISTANCE, REMOVE_DISTANCE, GameStatus, GALAXY_COLORS, CUSTOM_MAPS, LEVEL_KEYWORDS, getNeonColorForIndex } from '../../types';
...
export const LevelManager: React.FC = () => {
  ...
  useFrame((state, delta) => {
    ...
    if (furthestZ > -SPAWN_DISTANCE) {
         ...
         // Scale gap by map's obstacle frequency factor (higher frequency = smaller gaps)
         const gapFactor = 1.0 / (map.obstacleFrequency || 1.0);
         const minGap = (12 + (speed * 0.4)) * gapFactor; 
         ...
         if (isLetterDue) {
             ...
             if (availableIndices.length > 0) {
                 ...
                 const color = getNeonColorForIndex(chosenIndex);
